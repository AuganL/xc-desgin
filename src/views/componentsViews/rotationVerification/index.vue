...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      this.dataSource = [];
      let res = await rotationVerification();
    ...
    async del(row) {
      ...
      let res = await rotationVerificationDelete(params);
      this.getTableData();
    ...
    async editHandleOk() {
      if (this.modalType == "edit") {
        ...
        let res = rotationVerificationUpdate(params);
        ...
        if (this.addFrom) {
          ...
          console.log(params);
          let result = await rotationVerificationInsert(params);
          this.addFrom = {};
          this.getTableData();
