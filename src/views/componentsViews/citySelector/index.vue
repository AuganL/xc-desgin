...
// import { citySelector } from '../../../api/index'
export default {
  ...
  methods: {
    ...
    async del(row) {
      ...
      res.data.code == '200' ?  this.$message.success(res.data.message) : this.$message.error(res.data.message)
    ...
    async editHandleOk() {
      ...
      res.data.code == '200' ?  this.$message.success(res.data.message) : this.$message.error(res.data.message)
        ...
        if (this.addFrom) {
          ...
          console.log(params);
          let result = await calendarInsert(params);
          this.addFrom = {};
          this.getTableData();
          this.addModalVisible = false;
      res.data.code == '200' ?  this.$message.success(res.data.message) : this.$message.error(res.data.message)
