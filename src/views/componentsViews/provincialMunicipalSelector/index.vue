...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      this.dataSource = [];
      let res = await provincialMunicipalSelector();
    ...
    async del(row) {
      ...
      let res = await provincialMunicipalSelectorDelete(params);
      this.getTableData();
    ...
    async editHandleOk() {
      if (this.modalType == "edit") {
        ...
        let res = await provincialMunicipalSelectorUpdate(params);
        ...
        if (this.addFrom) {
          ...
          console.log(params);
          let result = await provincialMunicipalSelectorInsert(params);
          this.addFrom = {};
          this.getTableData();
