...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      this.dataSource = [];
      let res = await sliderVerification();
    ...
    async del(row) {
      ...
      let res = await sliderVerificationDelete(params);
      this.getTableData();
    ...
    async editHandleOk() {
      if (this.modalType == "edit") {
        ...
        let res = sliderVerificationUpdate(params);
        ...
        if (this.addFrom) {
          ...
          console.log(params);
          let result = await sliderVerificationInsert(params);
          this.addFrom = {};
          this.getTableData();
