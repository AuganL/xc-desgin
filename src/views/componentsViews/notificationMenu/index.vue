...
export default {
  ...
  methods: {
    ...
    async getTableData() {
      this.dataSource = [];
      let res = await notificationMenu();
    ...
    async del(row) {
      ...
      let res = await notificationMenuDelete(params);
      this.getTableData();
    ...
    async editHandleOk() {
      if (this.modalType == "edit") {
        ...
        let res = await notificationMenuUpdate();
        ...
        if (this.addFrom) {
          ...
          console.log(params);
          let result = await notificationMenuInsert(params);
          this.addFrom = {};
          this.getTableData();
